...
OneForthBase::OneForthBase()
{
    ...
    Unicode::snprintf(VoltageReadBuffer, VOLTAGEREAD_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID15).getText());
    VoltageRead.setWildcard(VoltageReadBuffer);
    VoltageRead.setTypedText(touchgfx::TypedText(T_SINGLEUSEID14));
    ...
    VoltageSet.setWildcard(touchgfx::TypedText(T_SINGLEUSEID17).getText());
    VoltageSet.setTypedText(touchgfx::TypedText(T_SINGLEUSEID16));
    ...
    Unicode::snprintf(PowerReadPrimBuffer, POWERREADPRIM_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID19).getText());
    PowerReadPrim.setWildcard(PowerReadPrimBuffer);
    PowerReadPrim.setTypedText(touchgfx::TypedText(T_SINGLEUSEID18));
    ...
    AmprageSet.setWildcard(touchgfx::TypedText(T_SINGLEUSEID21).getText());
    AmprageSet.setTypedText(touchgfx::TypedText(T_SINGLEUSEID20));
    ...
    PowerReadSec.setWildcard(touchgfx::TypedText(T_SINGLEUSEID23).getText());
    PowerReadSec.setTypedText(touchgfx::TypedText(T_SINGLEUSEID22));
